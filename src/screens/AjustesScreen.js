...
//Funcion para que se pueda acceder al cambio de estado de las apps vigiladas y mostrar las otras opciones en la pantalla
export default function AjustesScreen() {
    const [vigiladas, setVigiladas] = useState(["ig", "tk"]);
